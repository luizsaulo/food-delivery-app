      ...
      p-4 flex flex-col items-center justify-center gap-4'>
        {
          ...
          <div className='w-full py-2 border-p border-gray-300 flex items-center gap-2'>
              <MdFastfood className='text-xp text-gray-700' />
              <input 
                type='text' 
          ...
          <div className='w-full'>
            ...
            >
              ...
              {categories && categories.map(item => (
                <option 
                  key={item.id} className='text-base border-0 outline-none capitalize 
