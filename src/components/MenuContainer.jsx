...
const MenuContainer = () => {
  ...
  return (
    <section className='w-full my-6' id='menu'>
        ...
        <p className="text-2xl font-semibold capitalize text-headingColor relative before:-bottom-2
          before:absolute before:rounded-lg before:content before:w-16 before:h-1 
          before:left-0 before:bg-gradient-to-tr from-orange-400 to-orange-600 transition-all ease-in-out
        ...
        scrollbar-none'>
            {categories && categories.map(category => (
                <div key={category.id} className='group bg-card w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col 
